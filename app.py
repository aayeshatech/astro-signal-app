...
astro_symbols = st.sidebar.multiselect("Select Astro Planets", ["Sun", "Moon", "Mercury", "Venus", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune", "Pluto"], default=["Sun", "Moon", "Mercury"])

# === Load Ephemeris ===
eph = load('de421.bsp')
ts = load.timescale()

location = wgs84.latlon(28.6139 * N, 77.2090 * E)  # Delhi location

# === Define Market Time Range ===
